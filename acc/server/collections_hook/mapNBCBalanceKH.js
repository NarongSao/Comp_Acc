...
Acc.Collection.MapNBCBalanceKH.before.insert(function (userId, doc) {
...
Acc.Collection.MapNBCBalanceKH.before.update(function (userId, doc, fieldNames, modifier, options) {
