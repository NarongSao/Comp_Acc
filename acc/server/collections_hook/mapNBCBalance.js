...
Acc.Collection.MapNBCBalance.before.insert(function (userId, doc) {
...
Acc.Collection.MapNBCBalance.before.update(function (userId, doc, fieldNames, modifier, options) {
