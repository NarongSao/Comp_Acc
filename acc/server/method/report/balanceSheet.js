Meteor.methods({
    acc_BalanceSheetMulti: function(params) {
        ...
        var startYear = moment(fDate).format("YYYY");
        var startDate = moment(startYear + '-' + '01-01').toDate();
        /****** Title *****/
        dataMain.title = Cpanel.Collection.Company.findOne();
        ...
        if (self.date != null) {
            selectorGetLastDate.closeDate = {
                $lte: moment(self.date,"YYYY-MM-DD")
            };
        }
        ...
        result.forEach(function(o) {
            ...
            if (o.accountTypeId == "10") {
                ...
                dataOld = Acc.Collection.ChartAccount.findOne({
                    _id: temporary
                });
                ...
                if (o.level > 0) {
                    if (temporary !== o.parent) {
                        ...
                        otherCurrentAsset.push({
                            name: data.name,
                            code: Acc.SpaceChar.space(15 + (6 * data.level)) +
                            data.code,
                            amount: "title",
                            amountUsd: "title",
                            amountRiel: "title",
                ...
                otherCurrentAsset.push({
                    ...
                    amount: o.result,
                    currency: baseCurrency,
                    code: Acc.SpaceChar.space(15 + (6 * o.level)) + o.code,
                    level: o.level,
                    parent: o.parent,
                ...
                if (o.level > 0) {
                    if (temporary !== o.parent) {
                        ...
                        otherCurrentLiability.push({
                            name: data.name,
                            code: Acc.SpaceChar.space(22 + (6 * data.level)) +
                            data.code,
                            amount: "title",
                            amountUsd: "title",
                            amountRiel: "title",
                ...
                otherCurrentLiability.push({
                    ...
                    amount: x * o.result,
                    currency: baseCurrency,
                    code: Acc.SpaceChar.space(22 + (6 * o.level)) + o.code,
                    level: o.level,
                    parent: o.parent,
    ...
    acc_BalanceSheet: function(params) {
        ...
        if (self.date != null) {
            selectorGetLastDate.closeDate = {
                $lte: moment(self.date).format("YYYY-MM-DD")
            };
        }
        if (self.currencyId != "All") {
            selectorGetLastDate.currencyId = self.currencyId;
